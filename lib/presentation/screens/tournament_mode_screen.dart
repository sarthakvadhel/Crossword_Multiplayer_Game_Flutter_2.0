                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: CrosswordBoard(
                        ...
                        onTileTap: (idx) {
                          final sz = gameState.boardSize;
                          if (sz > 0) gameNotifier.placeLetterAt(idx ~/ sz, idx % sz);
                        },
                        isMultiplayer: false,
                        isLocalTurn: true,
                        hasOpponent: false,
                    ...
                    HandLetters(
                      ...
                      enabled: !_countdownActive && gameState.canAct,
                        ...
                        Expanded(
                          child: SwapPanel(
                            onSwap: _countdownActive || _resultPresented
                                ? null
                                : () {
                                    final idx = gameState.selectedHandIndex;
                                    if (idx != null) gameNotifier.swapLetter(idx);
                                  },
                          ),
                        ),
                        Expanded(
